# file contains helper function to create vpc, route tables, private & public subnets
from .. import config
from aws_cdk import (
    aws_ec2 as ec2,
)
...
def attach_internet_gateway(self) -> ec2.CfnInternetGateway:
    ...
    ec2.CfnVPCGatewayAttachment(self, 'internet-gateway-attachment', vpc_id=self.bifrost_vpc.vpc_id,
...
def create_instances_for_subnet(self, subnet: ec2.CfnSubnet, instance_id_to_config_map: {str: dict}):
