...
class AwsCommonServicesStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None: 
        ...
        vpc = ec2.Vpc(self, "AWS-Common-Services-VPC", cidr="10.10.0.0/16",
        ...
        public_subnet = ec2.CfnSubnet(
            self, public_subnet_id, vpc_id=vpc.vpc_id, cidr_block="10.10.1.0/24",
        ...
        private_subnet = ec2.CfnSubnet(
            self, private_subnet_id, vpc_id=vpc.vpc_id, cidr_block="10.10.2.0/24",
